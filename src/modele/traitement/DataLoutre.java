...
public class DataLoutre extends DataGeneral<ObsLoutre> {
    ...
    public static ArrayList<ObsLoutre> getAll (String str) throws NumberFormatException, SQLException {
    ...
    private static ArrayList<ObsLoutre> getFromResultSet (ResultSet rs) throws NumberFormatException, SQLException {
        ...
        if (rs == null) {
            ...
            while (rs.next()) {
                ...
                ArrayList<Observateur> liste_obervateurs = DataObservateur.getAll("Observateur, AObserve, ObsLoutre WHERE lobservateur = idObservateur AND lobservation = " + id + "\"");

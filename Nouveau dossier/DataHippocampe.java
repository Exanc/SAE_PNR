...
public class DataHippocampe extends DataGeneral<ObsHippocampe> {
    ...
    public ArrayList<ObsHippocampe> getAll (String str) throws NumberFormatException, SQLException {
    ...
    private static ArrayList<ObsHippocampe> getFromResultSet (ResultSet rs) throws NumberFormatException, SQLException {
        ...
        if (rs == null) {
            ...
            while (rs.next()) {
                ...
                ArrayList<Observateur> liste_obervateurs = new DataObservateur().getAll("Observateur, AObserve, ObsHippocampe WHERE lobservateur = idObservateur AND lobservation = " + id + "\"");
